...
const TRANSLATIONS = {
  HU: {
    ...
    otherWritingsSummary: "Novellák a Budavári siklóról, egy mérnökről, a bürokrácia bugyráról, Róth Weilerről, a Magyar Országos Asszonykörről és más történetek",
  ...
  EN: {
    ...
    otherWritingsSummary: "Short stories about the Buda Castle Funicular, an engineer, the depths of bureaucracy, Róth Weiler, the Hungarian National Women's Circle, and other tales",
